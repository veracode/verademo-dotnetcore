...
1. Log in to the application, note that you now have a "UserDetails" cookie.
...
3. Refresh the page. This should start the Windows Calculator, a proof of concept that any command can be executed.
